...
async function testarSistemaCompleto() {
    ...
    // TENTATIVA 1: Pedido sem cliente (Deve falhar)
    console.log("   > Testando erro sem cliente...");
    ...
    // TENTATIVA 2: Pedido Correto (Com Cliente ID 1)
    console.log("   > Enviando pedido válido vinculado ao Cliente 1...");
    const pedidoPayload = {
        customerId: 1, // NOVO: Obrigatório agora
        items: [
